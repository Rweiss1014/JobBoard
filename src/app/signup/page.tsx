...
function SignupForm() {
  ...
  const [accountType, setAccountType] = useState<'freelancer' | 'employer'>(
    defaultType as 'freelancer' | 'employer'
  );
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Join the L&D community and connect with opportunities
          </p>
        </div>

        {/* Account Type Selector */}
        <div className="bg-white rounded-lg border border-gray-200 p-1 mb-6 flex">
          <button
            type="button"
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                {accountType === 'freelancer' ? 'Full Name' : 'Your Name'}
              </label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                'Creating account...'
              ) : (
